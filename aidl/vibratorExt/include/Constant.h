...
using ::aidl::vendor::nameless::hardware::vibratorExt::Effect;
using ::aidl::vendor::nameless::hardware::vibratorExt::LevelRange;
using ::aidl::vendor::nameless::hardware::vibratorExt::LevelRangeConfig;
...
static const LevelRangeConfig LEVEL_RANGE_CONFIG_OP11_12_13_ACE3P = {
    .alarmCallLevelRange = {
        .maxLevel = 5,
        .defaultLevel = 4
    },
